      ...
      <div className="max-w-4xl mx-auto bg-gray-100 p-8 rounded-2xl shadow-lg border border-gray-300">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Berdasarkan hasil kuis, kamu memiliki kecenderungan kuat pada bidang teknologi, logika, dan pemecahan masalah sistematis. Kamu menikmati aktivitas yang melibatkan analisis, perhitungan, dan pengembangan solusi berbasis teknologi.
          </p>
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Karakteristik:</h2>
          <ul className="list-disc list-inside mt-3 text-gray-700 space-y-1">
            <li>Berpikir logis dan terstruktur</li>
            <li>Menyukai teknologi dan komputer</li>
            <li>Tertarik pada pemrograman dan sistem</li>
        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-xl border shadow-sm">
              <h3 className="font-semibold text-blue-900">UInstitut Teknologi Bandung (ITB)</h3>
              <p className="text-gray-700 text-sm">Informatika, Teknik Elektro</p>
            </div>
            <div className="bg-white p-4 rounded-xl border shadow-sm">
            ...
            <div className="bg-white p-4 rounded-xl border shadow-sm">
              ...
              <p className="text-gray-700 text-sm">Ilmu Komputer</p>
            </div>
            <div className="bg-white p-4 rounded-xl border shadow-sm">
