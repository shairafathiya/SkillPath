      ...
      <div className="max-w-4xl mx-auto bg-gray-100 p-8 rounded-2xl shadow-lg border border-gray-300">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Kamu termasuk tipe Auditory Learner. Kamu lebih mudah memahami materi melalui suara, penjelasan lisan, dan diskusi. Informasi akan lebih cepat dipahami jika kamu mendengarkannya secara langsung dibandingkan membaca teks panjang.
          </p>
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Karakteristik:</h2>
          <ul className="list-disc list-inside mt-3 text-gray-700 space-y-1">
            <li>Mudah memahami penjelasan secara lisan</li>
            <li>Suka berdiskusi dan bertanya langsung</li>
            <li>Lebih cepat mengingat informasi yang didengar</li>
            <li>Nyaman belajar sambil mendengarkan suara</li>
        ...
        <section className="mb-8">
          ...
          <div className="bg-white p-4 rounded-xl border shadow-sm">
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>Diskusi kelompok atau belajar bersama</li>
              <li>Mendengarkan rekaman audio pembelajaran</li>
              <li>Mengikuti penjelasan guru/dosen secara langsung</li>
              <li>Podcast edukasi atau presentasi lisan</li>
